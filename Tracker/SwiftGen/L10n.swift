...
internal enum L10n {
  /// What shall we track?
  internal static let baseScreenPrompt = L10n.tr("Localizable", "baseScreenPrompt", fallback: "What shall we track?")
  /// Cancel
  ...
  /// grouped by meaning
  internal static let categoryListDescription = L10n.tr("Localizable", "categoryListDescription", fallback: "Habits and events can be\ngrouped by meaning")
  /// No category
  ...
  ///   Tracker
  /// 
  ///   Created by Артем Солодовников on 18.05.2025.
