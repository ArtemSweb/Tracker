...
final class EditHabitViewController: UIViewController {
    ...
    private func updateScheduleUI() {
        scheduleButtonView.updateSubtitle(selectedSchedule.isEmpty ? nil : selectedSchedule.map { $0.shortDayName }.joined(separator: ", "))
    }
    ...
    private func updateCreateButtonState() {
        ...
        saveButton.backgroundColor = saveButton.isEnabled ? .tBlack : .gray
        let textColor = saveButton.isEnabled ? UIColor(resource: .tWhite) : UIColor(resource: .alwaysWhite)
